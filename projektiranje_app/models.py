...
class DesignTask(models.Model):
    ...
    datum_pocetka = models.DateField(
        null=True,
        blank=True,
        verbose_name=_("Datum početka projektiranja")
    )
    datum_zavrsetka = models.DateField(
        null=True,
        blank=True,
        verbose_name=_("Datum završetka projektiranja")
    )
    napomena = models.TextField(
        blank=True,
        null=True,
        verbose_name=_("Napomena / opis dizajna")
    )
    # Polja za audit trail
    created_at = models.DateTimeField(
        auto_now_add=True,
        verbose_name=_("Datum kreiranja")
    )
    updated_at = models.DateTimeField(
        auto_now=True,
        verbose_name=_("Datum posljednje izmjene")
    )
...
class DesignSegment(models.Model):
    ...
    segment_type = models.CharField(
        ...
        verbose_name=_("Tip segmenta")
    )
    opis = models.TextField(
        blank=True,
        null=True,
        verbose_name=_("Opis segmenta")
    )
    ...
    created_at = models.DateTimeField(
        auto_now_add=True,
        verbose_name=_("Datum kreiranja segmenta")
    )
    updated_at = models.DateTimeField(
        auto_now=True,
        verbose_name=_("Datum posljednje izmjene segmenta")
    )
...
class BillOfMaterials(models.Model):
    ...
    naziv = models.CharField(
        max_length=200,
        default="Glavni BOM",
        verbose_name=_("Naziv BOM-a")
    )
    opis = models.TextField(
        blank=True,
        null=True,
        verbose_name=_("Opis BOM-a")
    )
    status = models.CharField(
        max_length=50,
        default="draft",
        verbose_name=_("Status BOM-a")
    )
    created_at = models.DateTimeField(
        auto_now_add=True,
        verbose_name=_("Datum kreiranja")
...
class DesignRevision(models.Model):
    ...
    broj_revizije = models.PositiveIntegerField(
        default=1,
        verbose_name=_("Broj revizije")
    )
    opis = models.TextField(
        verbose_name=_("Opis promjena")
    )
...
class DynamicPlan(models.Model):
    ...
    json_data = models.JSONField(
        blank=True,
        null=True,
        verbose_name=_("Gantt podaci (JSON)")
    )
    pocetak_plana = models.DateField(
        null=True,
        blank=True,
        verbose_name=_("Početak plana")
    )
    kraj_plana = models.DateField(
        null=True,
        blank=True,
        verbose_name=_("Kraj plana")
    )
    napomena = models.TextField(
        blank=True,
        null=True,
