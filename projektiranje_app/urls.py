...
from .views import (
    DesignTaskViewSet, DesignSegmentViewSet, DynamicPlanViewSet,
    BillOfMaterialsViewSet, BOMItemViewSet, CADDocumentViewSet,
    DesignRevisionViewSet,
    DesignTaskListView, DesignTaskDetailView, DesignTaskCreateView, DesignTaskUpdateView,
...
urlpatterns = [
    ...
    path('projektiranje-home/', ProjektiranjeHomeView.as_view(), name='projektiranje-home'),
    
    # Design Task URLs
    path('design-tasks/', DesignTaskListView.as_view(), name='designtask_list'),
    path('design-tasks/<int:pk>/', DesignTaskDetailView.as_view(), name='designtask_detail'),
    path('design-tasks/create/', DesignTaskCreateView.as_view(), name='designtask_create'),
    path('design-tasks/<int:pk>/update/', DesignTaskUpdateView.as_view(), name='designtask_update'),
]
