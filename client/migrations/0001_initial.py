    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                code='invalid_oib', message='OIB mora imati točno 11 znamenki.', regex='^\\d{11}$'
                            )
                        ],
                        verbose_name='OIB',
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'post_sales_feedback',
                    models.TextField(blank=True, null=True, verbose_name='Post-prodajne povratne informacije'),
                ),
                (
                    'client',
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [
                    models.Index(fields=['postal_code'], name='client_city_postal__bddf1a_idx'),
                    models.Index(fields=['city'], name='client_city_city_77cf8f_idx'),
                ],
