...
class PositionAdmin(admin.ModelAdmin):
    form = PositionForm
    list_display = ('title', 'department', 'hierarchical_level', 'is_managerial', 'expertise_level')
    search_fields = ('title',)
    list_filter = ('department', 'hierarchical_level', 'is_managerial', 'expertise_level')
...
class EmployeeAdmin(admin.ModelAdmin):
    ...
    list_filter = ('department', 'position', 'is_active', 'expertise_level', 'access_level')
