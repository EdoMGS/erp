...
def employee_form(request, pk=None):
    ...
    return render(request, 'ljudski_resursi/employee_form.html', {'form': form, 'form_title': form_title, 'employee': employee})
...
def evaluacija_update(request, pk):
    ...
    return render(request, 'ljudski_resursi/evaluacija_form.html', {'form': form, 'evaluacija': evaluacija})
...
def evaluacija_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('ljudski_resursi:evaluacija_list')
    return render(request, 'ljudski_resursi/evaluacija_confirm_delete.html', {'evaluacija': evaluacija})
