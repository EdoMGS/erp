...
class PurchaseOrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'expected_delivery_date', 'status', 'work_order',
            'is_jit', 'delivery_schedule', 'reference_price',
            'agreed_price', 'justification_for_deviation'
        ]
...
class PurchaseOrderLineSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'purchase_order', 'artikl', 'artikl_naziv', 
                 'quantity', 'unit_price', 'discount', 'received_quantity']
