...
def add_stavka(request, pk):
    ...
    return render(request, 'nabava/stavka_form.html', {
        'form': form,
...
def dobavljac_edit(request, pk):
    ...
    return render(request, 'nabava/dobavljac_form.html', {
        'form': form,
        'dobavljac': dobavljac,
        'edit_mode': True
    })
...
def purchase_order_add_line(request, pk):
    ...
    return render(request, 'nabava/purchase_order_line_form.html', {
        'form': form,
        'order': order
    })
...
def grupa_dobavljaca_detail(request, pk):
    ...
    return render(request, 'nabava/grupa_dobavljaca_detail.html', {
        'grupa': grupa,
