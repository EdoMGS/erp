...
class ProjektiranjeHomeView(TemplateView):
    template_name = "projektiranje/home.html"


def index(request):
    return render(request, "projektiranje/home.html")
...
def design_task_view(request):
    ...
    return render(request, "projektiranje/design_task_view.html", {"documents": doks})
...
def dokumentacija_projektiranja_view(request):
    ...
    return render(
        request,
        "projektiranje/dokumentacija_projektiranja_list.html",
        {"docs": docs},
    )
...
class DesignTaskListView(ListView):
    model = DesignTask
    template_name = "projektiranje/designtask_list.html"
    context_object_name = "design_tasks"


class DesignTaskDetailView(DetailView):
    model = DesignTask
    template_name = "projektiranje/designtask_detail.html"
...
class BillOfMaterialsListView(ListView):
    ...
    template_name = "projektiranje/billofmaterials_list.html"
    context_object_name = "billofmaterials"


class BillOfMaterialsDetailView(DetailView):
    model = BillOfMaterials
    template_name = "projektiranje/billofmaterials_detail.html"
    context_object_name = "billofmaterials"
...
class BillOfMaterialsCreateView(CreateView):
    ...
    template_name = "projektiranje/billofmaterials_form.html"
    success_url = reverse_lazy("projektiranje:billofmaterials_list")
