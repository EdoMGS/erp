...
class ClientSupplierForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            'name', 'email', 'phone', 'oib', 'address', 
            'city', 'postal_code', 'county', 'country',
            'relationship_status', 'is_active', 'long_term_relationship'
        ]
        labels = {
            'name': 'Naziv',
            'address': 'Adresa',
...
class SalesOpportunityForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            'name', 'client', 'stage', 'budget', 
            'lead_source', 'project_service_type',
            'authority', 'need', 'timeframe',
            'assigned_to', 'public_tender_number'
        ]
        labels = {
