...
urlpatterns = [
    ...
    # FieldVisit
    path('opportunity/<int:opportunity_id>/fieldvisit/new/', views.fieldvisit_create, name='fieldvisit_create'),
    ...
    path('salescontract/<int:pk>/edit/', views.salescontract_edit, name='salescontract_edit'),
    path('salescontract/<int:pk>/', views.salescontract_detail, name='salescontract_detail'),
    path('salescontract/<int:pk>/delete/', views.salescontract_delete, name='salescontract_delete'),

    # Tender patterns
    path('tender/', views.tender_preparation_unified, name='tender_create'),
    path('tender/<int:pk>/<str:action>/', views.tender_preparation_unified, name='tender_preparation'),
