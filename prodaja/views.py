...
def opportunity_create(request):
    ...
    return render(request, 'prodaja/opportunity_form.html', {
        'form': form,
        'action': 'create'
    })
...
def opportunity_detail(request, pk):
    ...
    return render(request, 'prodaja/opportunity_detail.html', {
        'opportunity': obj,
        'visits': visits
    })
...
def opportunity_delete(request, pk):
    ...
    if request.method == 'POST':
        ...
        return redirect('prodaja:opportunity_list')
    return render(request, 'prodaja/confirm_delete.html', {
        'object': obj,
...
def fieldvisit_create(request, opportunity_id=None):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('prodaja:opportunity_detail', pk=visit.opportunity.id if visit.opportunity else opportunity_id)
    else:
        initial_data = {}
        if opportunity_obj:
            initial_data['opportunity'] = opportunity_obj
        form = FieldVisitForm(initial=initial_data)
    return render(request, 'prodaja/fieldvisit_form.html', {
        'form': form,
...
def quotation_create(request):
    if request.method == 'POST':
        ...
        form = QuotationForm()
    return render(request, 'prodaja/quotation_form.html', {
        'form': form,
        'action': 'create'
    })
...
def salesorder_create(request):
    if request.method == 'POST':
        ...
        form = SalesOrderForm()
    return render(request, 'prodaja/salesorder_form.html', {
        'form': form,
        'action': 'create'
    })
...
def salescontract_create(request):
    ...
    return render(request, 'prodaja/salescontract_form.html', {
        'form': form,
        'action': 'create'
    })
