...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='prodaja.tenderpreparation', verbose_name='Tender priprema'),
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tender', to='financije.financialanalysis', verbose_name='Financijska analiza'),
        ),
        migrations.AddField(
            model_name='tenderpreparation',
            name='hourly_rate',
            field=models.DecimalField(decimal_places=2, default=Decimal('50.00'), max_digits=8, verbose_name='Satnica (€)'),
        ),
        migrations.AddField(
            model_name='tenderpreparation',
            name='is_active',
        ...
        migrations.AddField(
            model_name='tenderpreparation',
            name='labor_hours',
            field=models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Radni sati'),
        ),
        migrations.AddField(
            model_name='tenderpreparation',
            name='material_costs',
            field=models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True, verbose_name='Troškovi materijala'),
        ),
        migrations.AddField(
            model_name='tenderpreparation',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='proizvodnja.projekt', verbose_name='Povezani projekt'),
        ),
        migrations.AddField(
            model_name='tenderpreparation',
            name='project_manager',
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name='Voditelj projekta (ime)'),
        ),
        migrations.AddField(
            model_name='tenderpreparation',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='tenders', to='projektiranje_app.designtask', verbose_name='Tehnički nacrti'),
        ),
        migrations.AddField(
            model_name='tenderpreparation',
