from ljudski_resursi.models import Department, Position, ExpertiseLevel, HierarchicalLevel, Employee
...
def create_minimal_employee(user):
    ...
    position = Position.objects.create(title="Worker", department=dept, hierarchical_level=hlevel, expertise_level=expertise)
