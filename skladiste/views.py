...
def inventory_list(request):
    ...
    return render(request, 'skladiste/inventory_list.html', {
        'artikli': artikli,
        'materijali': materijali,
        'title': 'Pregled skladišta'
    })
...
def primka_create(request):
    ...
    return render(request, 'skladiste/primka_form.html', {
        'form': form,
        'formset': formset
    })
...
class ArtiklCreateView(CreateView):
    ...
    fields = ['naziv', 'opis', 'sifra', 'jm', 'min_kolicina', 'trenutna_kolicina', 
              'nabavna_cijena', 'prodajna_cijena', 'kategorija', 'dobavljac', 'lokacija']
