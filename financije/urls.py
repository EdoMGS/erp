...
urlpatterns = [
    ...
    path('create_invoice_from_quote/<int:quote_id>/', views.create_invoice_from_quote, name='create_invoice_from_quote'),
    ...
    path('financial-reports/<int:pk>/', views.FinancialReportDetailView.as_view(), name='financial_report_detail'),
    path('financial-reports/create/', views.FinancialReportCreateView.as_view(), name='financial_report_create'),
    path('financial-reports/<int:pk>/edit/', views.FinancialReportUpdateView.as_view(), name='financial_report_edit'),
    ...
    path('tax-configurations/', views.TaxConfigurationListView.as_view(), name='tax_configuration_list'),
]