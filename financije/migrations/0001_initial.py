    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'bank_account_number',
                    models.CharField(
                        help_text='IBAN ili broj računa', max_length=34, verbose_name='Broj bankovnog računa (IBAN)'
                    ),
                ),
                ...
                (
                    'saldo',
                    models.DecimalField(
                        decimal_places=2, max_digits=12, verbose_name='Saldo računa (€) nakon transakcije'
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'predvidjeni_prihod',
                    models.DecimalField(decimal_places=2, max_digits=12, verbose_name='Predviđeni prihod (€)'),
                ),
                (
                    'predvidjeni_trosak',
                    models.DecimalField(decimal_places=2, max_digits=12, verbose_name='Predviđeni trošak (€)'),
                ),
                (
                    'stvarni_prihod',
                    models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Stvarni prihod (€)'),
                ),
                (
                    'stvarni_trosak',
                    models.DecimalField(decimal_places=2, default=0, max_digits=12, verbose_name='Stvarni trošak (€)'),
                ),
            ],
            options={
                'verbose_name': 'Proračun',
                'verbose_name_plural': 'Proračuni',
            },
        ),
        migrations.CreateModel(
            name='CashFlow',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'total_cost',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.00'), max_digits=15, verbose_name='Total Cost'
                    ),
                ),
                (
                    'expected_profit',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.00'), max_digits=15, verbose_name='Expected Profit'
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'total_price',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Ukupna cijena'
                    ),
                ),
                (
                    'vat_rate',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('25.00'), max_digits=4, verbose_name='Stopa PDV-a'
                    ),
                ),
                (
                ...
                (
                    'actual_costs',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Stvarni troškovi'
                    ),
                ),
                (
                    'predicted_profit',
                ...
                (
                    'actual_profit',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.00'), max_digits=12, verbose_name='Stvarna dobit (€)'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'invoice_number',
                    models.CharField(db_index=True, max_length=100, unique=True, verbose_name='Broj fakture'),
                ),
                ...
                (
                    'pdv_rate',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('25.00'), max_digits=5, verbose_name='Stopa PDV-a (%)'
                    ),
                ),
                (
                    'payment_method',
                    models.CharField(
                        choices=[('gotovina', 'Gotovina'), ('kartica', 'Kartica'), ('virman', 'Virman')],
                        default='virman',
                        max_length=20,
                ...
                (
                    'status_fakture',
                    models.CharField(
                        choices=[('draft', 'Draft'), ('odobreno', 'Odobreno'), ('otkazano', 'Otkazano')],
                        default='draft',
                        max_length=20,
                ...
                ('stripe_link', models.URLField(blank=True, null=True, verbose_name='Stripe Link')),
                ...
                (
                    'public_tender_ref',
                    models.CharField(blank=True, max_length=100, null=True, verbose_name='Referenca javnog natječaja'),
                ),
                (
                    'amount',
                    models.DecimalField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'ukupni_overhead',
                    models.DecimalField(decimal_places=2, max_digits=12, verbose_name='Ukupni overhead (€)'),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'tax_rate',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.00'), max_digits=5, verbose_name='Stopa prireza (%)'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primka_ref', models.CharField(blank=True, max_length=64, null=True, verbose_name='Primka Ref')),
            ],
            options={
                'verbose_name': 'Račun',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Client')),
            ],
        ),
        migrations.CreateModel(
            name='Tax',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='Aktivna konfiguracija')),
                (
                    'mirovinsko_1',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.15'), max_digits=4, verbose_name='Mirovinsko 1'
                    ),
                ),
                (
                    'mirovinsko_2',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.05'), max_digits=4, verbose_name='Mirovinsko 2'
                    ),
                ),
                (
                    'zdravstveno',
                    models.DecimalField(
                        decimal_places=3, default=Decimal('0.165'), max_digits=5, verbose_name='Zdravstveno'
                    ),
                ),
                (
                    'niza_stopa',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.20'), max_digits=4, verbose_name='Niža stopa poreza'
                    ),
                ),
                (
                    'visa_stopa',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.30'), max_digits=4, verbose_name='Viša stopa poreza'
                    ),
                ),
                (
                    'osobni_odbitak',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('560.00'), max_digits=10, verbose_name='Osobni odbitak'
                    ),
                ),
                (
                    'prirez',
                    models.DecimalField(decimal_places=2, default=Decimal('0.50'), max_digits=4, verbose_name='Prirez'),
                ),
                (
                    'granica_visa_stopa',
                    models.DecimalField(
                ...
                (
                    'minimal_salary',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('780.00'), max_digits=10, verbose_name='Minimalna plaća (€)'
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'variable_pay',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.00'), max_digits=10, verbose_name='Varijabilni dio (€)'
                    ),
                ),
                (
                    'bonus',
                    models.DecimalField(
                        decimal_places=2, default=Decimal('0.00'), max_digits=10, verbose_name='Bonus (€)'
                    ),
                ),
            ],
            options={
