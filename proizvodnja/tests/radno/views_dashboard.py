...
class DashboardView(LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.user.is_staff or (hasattr(request.user, 'zaposlenik') and request.user.zaposlenik.role in ['Administrator', 'Voditelj Proizvodnje']):
...
def api_dashboard_data(request):
    ...
    if korisnik.is_staff or (hasattr(korisnik, 'zaposlenik') and korisnik.zaposlenik.role in ['Administrator', 'Voditelj Proizvodnje']):
        response_data = {
