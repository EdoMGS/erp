...
class RadniNalogMaterijalAdmin(admin.ModelAdmin):
    form = RadniNalogMaterijalForm
    list_display = ('radni_nalog', 'materijal', 'kolicina')  # Changed 'artikl' to 'materijal'
    search_fields = ('radni_nalog__naziv_naloga', 'materijal__naziv')  # Changed 'artikl' to 'materijal'
