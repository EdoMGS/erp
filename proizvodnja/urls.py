...
MIDDLE_MANAGEMENT = ["Voditelj Projekta", "Voditelj Proizvodnje", "Nabava", "Projektant"]
...
urlpatterns = [
    ...
    # Work orders
    path('projekt/<int:projekt_id>/radni-nalozi/', views.lista_radnih_naloga, name='lista_radnih_naloga'),
    ...
    path('materijali/<int:radni_nalog_id>/', views.lista_materijala, name='lista_materijala_po_nalogu'),
    ...
    path('video-pitanje/dodaj/', 
         login_required(DodajVideoPitanjeView.as_view()), 
         name='dodaj_video_pitanje'),
    path('video-pitanje/<int:pk>/obrisi/', 
         login_required(ObrisiVideoPitanjeView.as_view()), 
         name='obrisi_video_pitanje'),

    # Quality evaluations
    path('ocjene-kvalitete/<int:radni_nalog_id>/', 
         login_required(ListaOcjenaKvaliteteView.as_view()), 
         name='lista_ocjena_kvalitete'),
    path('ocjena-kvalitete/<int:pk>/', 
         login_required(DetaljiOcjeneKvaliteteView.as_view()), 
         name='detalji_ocjene_kvalitete'),
    path('ocjena-kvalitete/<int:pk>/edit/', 
         login_required(AzurirajOcjenuView.as_view()), 
         name='azuriraj_ocjenu_kvalitete'),
    path('ocjena-kvalitete/dodaj/', 
         login_required(DodajOcjenuView.as_view()), 
         name='dodaj_ocjenu_kvalitete'),
    path('ocjena-kvalitete/<int:pk>/obrisi/', 
         login_required(ObrisiOcjenuView.as_view()), 
         name='obrisi_ocjenu_kvalitete'),

    # Universal work order form
    path('radni-nalog/univerzalni/<str:action>/', views.univerzalni_radni_nalog, name='univerzalni_radni_nalog'),
    path('radni-nalog/univerzalni/<int:pk>/<str:action>/', views.univerzalni_radni_nalog, name='univerzalni_radni_nalog_edit'),
    path('radni-nalog/univerzalni/', views.univerzalni_radni_nalog, name='univerzalni_radni_nalog_new'),
    path('radni-nalog/univerzalni/<int:pk>/', views.univerzalni_radni_nalog, name='univerzalni_radni_nalog_edit'),
    path('radni-nalog/univerzalni/<int:pk>/view/', views.univerzalni_radni_nalog, {'action': 'view'}, name='univerzalni_radni_nalog_view'),
